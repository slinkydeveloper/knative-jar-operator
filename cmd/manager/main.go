...
import (
	...
	"github.com/slinkydeveloper/knative-jar-operator/pkg/apis"
	"github.com/slinkydeveloper/knative-jar-operator/pkg/controller"
...
func main() {
	...
	err = leader.Become(ctx, "knative-jar-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
